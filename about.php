                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-8 col-xxl-6">
                            <div class="text-center my-5">
                                ...
                                <a class="btn btn-primary2 btn-lg" href="#scroll-target">Whatsapp</a>
                                <a class="btn btn-primary btn-lg" href="#scroll-target">Discord</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container px-5 my-5">
                    ...
                    <div class="row gx-5 row-cols-1 row-cols-sm-2 row-cols-xl-4 justify-content-center">
                        <div class="col mb-5 mb-5 mb-xl-0">
                            <div class="text-center">
                                <img class="img-fluid rounded-circle mb-4 px-4" src="https://i.imgur.com/56DI2vY.jpg" alt="..." />
